...
const faqs = [
  ...
  {
    question: "Почему у вас дешевле, чем у официального дилера?",
    answer:
      "Нет дилерской наценки за бренд, маркетинговых расходов и административных издержек крупной сети. Только честная стоимость работ и запчастей. При этом качество — то же, а экспертиза по Volvo — глубже.",
  },
] as const;
