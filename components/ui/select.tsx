    ...
    <>
      <div className={cn("relative", className)}>
        ...
        <button
          ...
          type="button"
          className={cn(
            "flex h-11 w-full items-center justify-between rounded-[1.15rem] border border-white/10 bg-[rgba(255,255,255,0.06)] px-3.5 text-left text-base text-white outline-none transition sm:h-12 sm:rounded-2xl sm:px-4 sm:text-sm",
